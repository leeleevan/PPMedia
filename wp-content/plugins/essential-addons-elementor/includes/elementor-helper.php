...
trait ElementsCommonFunctions {
    ...
    protected function query_controls(){
        ...
        // if( 'eael-content-timeline' !== $this->get_name() && 'eael-content-ticker' !== $this->get_name() && 'eae-advanced-slider' !== $this->get_name() ) {
        //     $this->start_controls_section(
        //         'eael_section_post_timeline_filters',
        //         [
        //             'label' => __( 'Query', 'essential-addons-elementor' ),
        ...
        // if( 'eae-advanced-slider' === $this->get_name() ) {
        //     $this->start_controls_section(
        //         'eael_advanced_slider_filters',
        //         [
        //             'label'     => __( 'Query', 'essential-addons-elementor' ),
        //             'condition' => [
        //                 'eae_adv_slider_source_type' => 'query'
        //             ]
        //         ]
        //     );
        // }
...
function eael_get_cats_list_custom() {
