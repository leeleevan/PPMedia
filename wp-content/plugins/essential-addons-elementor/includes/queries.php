...
// Get all Product Atts
if ( !function_exists('eael_get_product_atts') ) {
    function eael_get_product_atts() {
        $options = array();
...
/**
 * This function is responsible for getting the all menus.
 *
 * @return array of menus.
 */
function eael_get_menus() {
