    ...
    protected function render()
    {
		...
		<script>
			jQuery(document).ready(function(){
				setTimeout(function() {
					jQuery('.eael-post-grid:not(.eael-post-carousel)').masonry({
		...
		<?php if (1 == $settings['show_load_more']):
            if ($settings['posts_per_page'] != '-1' && $total_post != $settings['posts_per_page'] && $total_post > intval($settings['offset']) + intval(!empty($settings['posts_per_page']) ? $settings['posts_per_page'] : 4)): ?>
			<!-- Load More Button -->
